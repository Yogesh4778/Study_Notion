...
const VideoDetails = () => {
    ...
    useEffect(() => {
        ...
        if(!courseId && !sectionId && !subSectionId){
            ...
            //let's assume we have all 3 fields present
            //now fetch the video which is randered at UI
            //section
  ...
  //since prev btn is not available for first video so we need this fn.
  const isFirstVideo = () => {
  ...
  const goToNextVideo = () => {
    ...
    //more video's are present inside the section means go to next video of same section
  ...
  const goToPrevVideo = () => {
    ...
    //more video's are present inside the Section means go to prev video of same section
